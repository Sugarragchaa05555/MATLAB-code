% Load the .mat files
loadedAVGHarDat3 = load('AVGHarDat3.mat');

% Assuming timeStr2 is an array of strings representing time
timeObjects = datetime(timeStr3, 'Format', 'HH:mm:ss');
...
for M = 1:3:72
    Amplitude1 = [Amplitude1 table2array(loadedAVGHarDat3.AVGHarmonicData3(:,M))];
end
...
for M = 2:3:72
    AmplitudeL2 = [AmplitudeL2 table2array(loadedAVGHarDat3.AVGHarmonicData3(:,M))];
end
...
for M = 3:3:72
    AmplitudeL3 = [AmplitudeL3 table2array(loadedAVGHarDat3.AVGHarmonicData3(:,M))];
end
